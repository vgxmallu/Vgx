...
REGEX_SITES = (
    r"^((?:https?:)?\/\/)"
    r"?((?:www|m)\.)"
    r"?((?:soundcloud\.com|mixcloud\.com|on.soundcloud.com))" #youtube\.com|youtu\.be| 
    r"(\/)([-a-zA-Z0-9()@:%_\+.~#?&//=]*)([\w\-]+)(\S+)?$"
)
REGEX_EXCLUDE_URL = (
...
async def _upload_audio(message: Message, info_dict, audio_file):
    ...
    caption = f"<i><a href=\"{webpage_url}\">song.link</a> | <a href=\"http://t.me/Musicx_dlbot\">via</a></i>"
